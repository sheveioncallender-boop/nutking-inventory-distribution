...
Use a new Odoo 19 Community staging database. Do not test first on a live production database.
...
- [ ] Confirm the Nut King app icon and dashboard load without an RPC error.
- [ ] Confirm Inventory, Contacts and Mail dependencies install automatically.
