...
## 19.0.5.0.0 — Odoo-native hybrid transfers
...
- Updates workspace, service-worker, reset, and API versions to v0.5.0.
...
- Full management-report expansion is planned as the next reporting stage and is not the focus of v0.5.0.
...
- This workflow is retained only for legacy audit records after the v0.5.0 native-transfer conversion.
