...
class NutkingDashboard(models.Model):
    ...
    def _rapid_scan_action(self, operation_type):
        return {
            ...
            'url': f'/nutking/#scan/{operation_type}',
            'target': 'self',
        }
    ...
    def action_raw_physical_inventory(self):
        return {'type': 'ir.actions.act_url', 'url': '/nutking/#inventory/raw', 'target': 'self'}

    def action_finished_physical_inventory(self):
        return {'type': 'ir.actions.act_url', 'url': '/nutking/#inventory/finished', 'target': 'self'}

    def action_trips(self):
        return {'type': 'ir.actions.act_url', 'url': '/nutking/#distribution', 'target': 'self'}

    def action_operations(self):
        return {'type': 'ir.actions.act_url', 'url': '/nutking/#operations', 'target': 'self'}
