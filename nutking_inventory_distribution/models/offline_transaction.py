...
class NutkingOfflineTransaction(models.Model):
    ...
    transaction_kind = fields.Selection(
        [
            ...
            ('native_transfer', 'Native Odoo Transfer'),
            ('native_transfer_event', 'Native Transfer Action'),
            ('native_return', 'Native Transfer Return'),
            ('contact_create', 'Create Customer / Company'),
        ],
