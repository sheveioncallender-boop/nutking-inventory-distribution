...
## Version 19.0.1.0.5 staging correction

- The Nut King app is visible automatically to Odoo Settings administrators.
- The top-level app menu uses the exact supplied Nut King logo from a new asset path, forcing Odoo to refresh the prior cached icon.
- Operational staff still require one of the Nut King role groups.
