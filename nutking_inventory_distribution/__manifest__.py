...
custom stock operations with Draft, Confirmed, Completed and Cancelled lifecycle controls, official and provisional printing, a complete offline-first worker workspace, rapid barcode scanning with three-character product autocomplete, native physical inventory, trucks as mobile stock locations,
