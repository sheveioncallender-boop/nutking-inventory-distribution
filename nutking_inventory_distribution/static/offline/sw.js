const CACHE = 'nutking-operations-v0.3.1';
...
const CORE_ASSETS = [
  APP_SHELL,
  '/nutking_inventory_distribution/static/offline/app-v0.3.1.css',
  '/nutking_inventory_distribution/static/offline/app-v0.3.1.js',
...
self.addEventListener('fetch', (event) => {
  ...
  if (request.mode === 'navigate' && url.pathname.startsWith('/nutking')) {
